...
const routes = [
    ...
    {
        path: 'video',
        loadChildren: () => __webpack_require__.e(/*! import() | video-video-module */ "video-video-module").then(__webpack_require__.bind(null, /*! ./video/video.module */ "./src/app/video/video.module.ts")).then(m => m.VideoPageModule)
    },
    {
        path: 'intro',
