...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppHomeHomePageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-header>\n  <ion-toolbar>\n    <img alt=\"logo\" slot=\"end\" height=\"40px\" src=\"assets/img/Logo_WhiteStacked_1024x1024.png\">\n      <ion-buttons slot=\"end\">\n      <ion-menu-button></ion-menu-button>\n      </ion-buttons>\n    <ion-title>\n      {{pagetitle | translate}}\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-padding\" id=\"home\" (ionScrollEnd)=\"scrollStop($event)\" (ionScroll)=\"scrollHandler($event)\">\n\n  <ion-searchbar style=\"box-shadow: none !important;\" [(ngModel)]=\"searchTerm\" (search)=\"search($event)\" value=\"\" placeholder=\"\"></ion-searchbar>\n  \n  <div class=\"dropdowns\">\n    <!-- <ion-item>\n      <ion-label>{{'filter.by' | translate}}</ion-label>\n      <ion-select [(ngModel)]=\"filterBy\" (ionChange)=\"filter($event)\">\n        <ion-select-option value=\"name\">{{'filter.name' | translate}}</ion-select-option>\n        <ion-select-option value=\"type\">{{'filter.type' | translate}}</ion-select-option>\n        <ion-select-option value=\"location\">{{'filter.location' | translate}}</ion-select-option> -->\n\n  <ion-list  class=\"bshadow\">\n  <ion-item >\n    <ion-label class=\"box-categories\">{{selectcategories | translate}}</ion-label>\n    <ion-select [okText]=\"'okText' | translate\" [cancelText]=\"'cancelText' | translate\" [(ngModel)]=\"categories\" multiple=\"true\" (ionChange)=\"search();\">\n      <!-- <ion-item [hidden]=\"language!=='en'\"> -->\n      <!-- <ion-select-option *ngFor=\"let category of categoryENList | async\" value={{category.category}}>{{category.category}}</ion-select-option> -->\n      <ion-select-option>{{catAddiction | translate}}</ion-select-option>\n      <ion-select-option>{{catDevelopment | translate}}</ion-select-option>\n      <ion-select-option>{{catEducation | translate}}</ion-select-option>\n      <ion-select-option>{{catEmergency | translate}}</ion-select-option>\n      <ion-select-option>{{catEmployment | translate}}</ion-select-option>\n      <ion-select-option>{{catFamily | translate}}</ion-select-option>\n      <ion-select-option>{{catGov | translate}}</ion-select-option>\n      <ion-select-option>{{catHome | translate}}</ion-select-option>\n      <ion-select-option>{{catHospitalsMed | translate}}</ion-select-option>\n      <ion-select-option>{{catHospitalsPsy | translate}}</ion-select-option>\n      <ion-select-option>{{catHousing | translate}}</ion-select-option>\n      <ion-select-option>{{catLegal | translate}}</ion-select-option>\n      <ion-select-option>{{catMedical | translate}}</ion-select-option>\n      <ion-select-option>{{catMental | translate}}</ion-select-option>\n      <ion-select-option>{{catResidential | translate}}</ion-select-option>\n      <ion-select-option>{{catSeniors | translate}}</ion-select-option>\n      <ion-select-option>{{catSuicide | translate}}</ion-select-option>\n      <ion-select-option>{{catWomen | translate}}</ion-select-option>\n      <ion-select-option>{{catYouth | translate}}</ion-select-option>\n      \n\n\n      \n\n    <!-- </ion-item> -->\n      <!-- <ion-select-option *ngFor=\"let category of categoryESList | async\" value={{category.category}}>{{category.category}}</ion-select-option> -->\n      \n    </ion-select>\n  </ion-item>\n</ion-list>\n\n\n  <ion-list class=\"bshadow\">\n  <ion-item>\n    <ion-label class=\"box-cities\">{{selectcities | translate}}</ion-label>\n    <ion-select  [okText]=\"'okText' | translate\" [cancelText]=\"'cancelText' | translate\" [(ngModel)]=\"cities\" multiple=\"true\" cancelText=\"Cancel\" okText=\"Select\" (ionChange)=\"search();\">\n      <ion-select-option *ngFor=\"let city of cityList | async\" value={{city.city}}>{{city.city}}</ion-select-option>\n    </ion-select>\n  </ion-item>\n  </ion-list>\n  </div>\n  <ion-list class=\"ion-padding\">\n  <ion-list *ngFor=\"let resource of searchResults | async\" >\n      <ion-grid>\n<ion-row>\n\n  <ion-col size=\"2\">\n    <div class=\"center\"><ion-checkbox style=\"width: 100%; height: auto;\" checked=\"false\" [(ngModel)]=\"resource.checked\" (ionChange)=\"updateSelected($event, resource)\">\n    </ion-checkbox></div>\n  </ion-col>\n  <ion-col size=\"1\">\n\n  </ion-col>\n  <ion-col size=\"9\">\n    <ion-label style=\"height:auto; display:flex; vertical-align: 50%;\" class=\"ion-text-wrap\" [routerLink]=\"['/details', resource.key]\">\n        <p class=\"ion-text-wrap\"><b>{{resource.ProgramName}}</b><br><br> \n          {{resource.Address}}<br>\n          {{resource.LocationCity}}, {{resource.LocationState}} {{resource.Zip}}\n        </p>\n    </ion-label>\n  </ion-col>\n  \n      <!-- <ion-item lines=\"none\">\n          <ion-checkbox checked=\"false\" [(ngModel)]=\"resource.checked\" (ionChange)=\"updateSelected($event, resource)\">\n          </ion-checkbox>\n        <ion-label style=\"height:auto; display:flex; vertical-align: 50%;\" class=\"ion-text-wrap\" [routerLink]=\"['/details', resource.key]\">\n            <p class=\"ion-text-wrap\"><b>{{resource.ProgramName}}</b><br><br> \n              {{resource.Address}}<br>\n              {{resource.LocationCity}}, {{resource.LocationState}} {{resource.Zip}}\n            </p>\n        </ion-label>\n    </ion-item> -->\n    \n    </ion-row>\n  </ion-grid>\n  </ion-list>\n  </ion-list>\n  <ion-fab vertical=\"bottom\" horizontal=\"end\" slot=\"fixed\">\n    <ion-fab-button (click)=\"presentActionSheet()\" [translate] >\n      <ion-icon name=\"share\"></ion-icon>\n      <ion-label>{{selectItems}}</ion-label>\n    </ion-fab-button>\n  </ion-fab>\n  \n    <ion-fab vertical=\"bottom\" horizontal=\"center\" slot=\"fixed\" >\n      <ion-fab-button (click)=\"scrollToTop()\" >\n        <ion-icon name=\"chevron-up\"></ion-icon>\n        <!-- <ion-label>Scroll to Top</ion-label> -->\n      </ion-fab-button>\n  </ion-fab>\n  \n  </ion-content>\n\n\n\n";
    /***/
  },
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{
        path: '',
  ...
  function srcAppHomeHomePageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "/* Styles checkbox*/\nion-checkbox {\n  --background: transparent !important;\n  --background-checked: transparent !important;\n  --border-color: rgba(255,255,255,0.5) !important;\n  --border-color-checked: #01ff80 !important;\n  --checkmark-color: #01ff80 !important;\n  --border-radius: 150px;\n  width: calc(30px + 4vw);\n  height: auto;\n  margin-right: 50px;\n}\nion-item {\n  --border: transparent !important;\n}\n/* Styles top toolbar */\nion-toolbar {\n  color: white;\n  --background: #3064ab;\n  box-shadow: none;\n}\n/* Removes header drop shadow */\nion-header {\n  z-index: 0;\n}\n/* Styles background color of every item on page content*/\nion-content {\n  --ion-background-color: linear-gradient(180deg, #3064ab 0%, #0c499c 50%, #03216e 100%) !important;\n}\n/* Styles searcbar*/\n.sc-ion-searchbar-md-h {\n  --clear-button-color: initial;\n  --cancel-button-color: var(--ion-color-step-900,#fff);\n  --color: var(--ion-color-step-850,#fff);\n  --icon-color: var(--ion-color-step-600,#fff);\n  --background: transparent !important;\n}\n/* Styles 2 dropdowns*/\nion-item {\n  --background: transparent !important;\n  --color: #fff !important;\n  --border-color: var(--ion-item-border-color,var(--ion-border-color,var(--ion-color-step-150,rgba(255,255,255,0.13))));\n}\n/* Styles 2 dropdowns bacground color*/\n.list-md {\n  background: transparent !important;\n}\n/* Styles each resources font colors*/\np {\n  text-align: left;\n  color: #fff;\n}\nb {\n  color: #fff;\n  font-size: 12pt;\n}\n/* Styles each resources background color*/\nion-list {\n  --color: var(--ion-color-step-850,#fff);\n  --background: transparent !important;\n}\n/* Styles share button*/\nion-fab-button {\n  --color: var(--ion-color-step-850,#fff);\n  --background: radial-gradient(#00cd67 20%, #01ff80 100%) !important;\n}\nion-label {\n  border: none !important;\n  outline: none !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(resourceListService, modalCtrl, zone, toastController, router, modalController, actionSheetController, firebaseAnalytics, _translate, translateService) {
        var _this = this;
        ...
        console.log(this.translateService.getDefaultLanguage()); // if (this._translate.getBrowserLang() !== undefined) {
        ...
        this.categoryESList = this.resourceListService.getCategoryESList(); // console.log(this.categoryESList)
        ...
        this.searchThisList = this.resourceListService.getResourceList(); // if (this.language = 'en'){
        ...
        this.searchResults.forEach(function (result) {
          _this.numberOfSearchResults = result.length; // console.log(result.checked)
      ...
      _createClass(HomePage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.catYouth = "categories.Youth"; // if (this.language = 'en'){
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    this._translate.get('sharemenu.clear').subscribe(function (res) {
                      console.log(res);
                      _this5.acClear = res;
                    });

                    this._translate.get('sharemenu.cancel').subscribe(function (res) {
                      console.log(res);
                      _this5.acCancel = res;
                    });

                    this._translate.get('sharemenu.close').subscribe(function (res) {
                      console.log(res);
                      _this5.acClose = res;
                    });

                    this._translate.get('sharemenu.shareallresults').subscribe(function (res) {
                      console.log(res);
                      _this5.acShareAll = res;
                    });

                    this._translate.get('sharemenu.share').subscribe(function (res) {
                      console.log(res);
                      _this5.acShare = res;
                    });
        ...
        value: function shareSelected() {
          ...
          for (var i = 0; i < this.selectedResources.length; i++) {
            ...
            var email = this.selectedResources[i].EmailAddress; // Log resource individually as shared into Firebase Analytics

            this.firebaseAnalytics.logEvent('share', {
              resources_shared: name
            });
  ...
  function srcAppServicesResourceListServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ResourceListService = /*#__PURE__*/function () {
      ...
      _createClass(ResourceListService, [{
        ...
        key: "getCategoryESList",
        value: function getCategoryESList() {
          return this.db.list('categories_es', function (ref) {
            return ref.orderByChild('category_es');
          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (changes) {
            // console.log(changes);
            return changes.map(function (c) {
              return Object.assign({
        ...
        key: "getCategoryFRList",
        value: function getCategoryFRList() {
          return this.db.list('categories_fr', function (ref) {
            return ref.orderByChild('category_fr');
          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (changes) {
            // console.log(changes);
            return changes.map(function (c) {
              return Object.assign({
        ...
        key: "getCategoryVIList",
        value: function getCategoryVIList() {
          return this.db.list('categories_vi', function (ref) {
            return ref.orderByChild('category_vi');
          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (changes) {
            // console.log(changes);
            return changes.map(function (c) {
              return Object.assign({
        ...
        key: "getCategoryZHList",
        value: function getCategoryZHList() {
          return this.db.list('categories_zh', function (ref) {
            return ref.orderByChild('category_zh');
          }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (changes) {
            // console.log(changes);
            return changes.map(function (c) {
              return Object.assign({
