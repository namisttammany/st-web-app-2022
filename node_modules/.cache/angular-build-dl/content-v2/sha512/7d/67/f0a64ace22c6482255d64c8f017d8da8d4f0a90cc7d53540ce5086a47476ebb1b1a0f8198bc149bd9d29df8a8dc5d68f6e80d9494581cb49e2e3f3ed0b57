...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[38], {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 8;
                  return regeneratorRuntime.awrap(Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_10__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps));

                case 8:
                  this.usersElement = _context2.sent;
                  _context2.next = 11;
                  return regeneratorRuntime.awrap(Object(_index_4e2fa3c6_js__WEBPACK_IMPORTED_MODULE_11__["d"])(this.usersElement));

                case 11:
                  _context2.next = 13;
                  return regeneratorRuntime.awrap(Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_8__["e"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement));
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  ...
                  _context3.next = 5;
                  return regeneratorRuntime.awrap(Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_8__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement));
                ...
                case 5:
                  ...
                  _context3.next = 9;
                  return regeneratorRuntime.awrap(Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_10__["d"])(this.delegate, this.usersElement));
  ...
  function node_modulesIonicCoreDistEsmTheme18cbe2ccJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var openURL = function openURL(url, ev, direction) {
      var router;
      return regeneratorRuntime.async(function openURL$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", router.push(url, direction));
