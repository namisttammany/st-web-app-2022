...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["details-details-module"], {
  ...
  function srcAppDetailsDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @ngx-translate/core */
    "./node_modules/@ngx-translate/core/fesm2015/ngx-translate-core.js"); // import { DetailsPageRoutingModule } from './details-routing.module';
    // const routes: Routes = [
    //   {
    //     path: '',
    ...
    DetailsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forChild([{
        path: '',
  ...
  function srcAppDetailsDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "snapshotToObject", function () {
    ...
    var _services_favorites_list_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _share_modal_share_modal_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../share-modal/share-modal.page */
    "./src/app/share-modal/share-modal.page.ts");
    /* harmony import */


    var _flag_flag_page__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../flag/flag.page */
    ...
    /*! @ngx-translate/core */
    "./node_modules/@ngx-translate/core/fesm2015/ngx-translate-core.js"); // import { PhoneselectModalPage } from '../phoneselect-modal/phoneselect-modal.page';


    var DetailsPage = /*#__PURE__*/function () {
      function DetailsPage(callNumber, launchNavigator, inAppBrowser, modalController, toastController, platform, favoriteProvider, route, router, actionSheetController, firebaseAnalytics, _translate) {
        var _this = this;
        ...
        firebase__WEBPACK_IMPORTED_MODULE_9__["database"]().ref('resource/' + this.route.snapshot.paramMap.get('key')).on('value', function (resp) {
          _this.resource = snapshotToObject(resp);
          console.log(_this.resource);
          return false;
        });
        console.log(this.resource);
        this.resourceString = JSON.stringify(this.resource);
        this.favoriteProvider.isFavorite(this.resourceString).then(function (isFav) {
      ...
      _createClass(DetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.firebaseAnalytics.logEvent('resource_viewed', {
            resource_viewed: this.resource.ProgramName
          });
          ...
          this._translate.get('details.flag').subscribe(function (res) {
            console.log(res);
            _this2.flag = res;
          });

          this._translate.get('details.share').subscribe(function (res) {
            console.log(res);
            _this2.share = res;
          });

          this._translate.get('details.call').subscribe(function (res) {
            console.log(res);
            _this2.call = res;
          });

          this._translate.get('details.navigate').subscribe(function (res) {
            console.log(res);
            _this2.navigateTo = res;
          });

          this._translate.get('details.website').subscribe(function (res) {
            console.log(res);
            _this2.goToWebsite = res;
          });
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        _this3.dataReturned = dataReturned.data; // alert('Modal Sent Data :'+ this.dataReturned);
                      }
                    });
                    _context2.next = 6;
        ...
        key: "openFlagModal",
        value: function openFlagModal(data) {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        _this4.dataReturned = dataReturned.data; // alert('Modal Sent Data :'+ this.dataReturned);
                      }
                    });
                    _context3.next = 6;
                    return modal.present();
                    ...
                    return this.actionSheetController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          _this5.flagResource(); // this.router.navigate(['/home'])
                          // this.clearSelected();
        ...
        value: function favoriteResource() {
          var _this6 = this;

          this.favoriteProvider.favoriteResource(this.resourceString).then(function () {
            _this6.isFavorite = true;

            _this6.showToast('Resource added to Favorites.');
          });
          this.firebaseAnalytics.logEvent('favorite_added', {
            favorite_added: this.resource.ProgramName
          }); // .then((res: any) => console.log(res))
          // .catch((error: any) => console.error(error));
        }
      }, {
        key: "unfavoriteResource",
        value: function unfavoriteResource() {
          var _this7 = this;

          this.favoriteProvider.unfavoriteResource(this.resourceString).then(function () {
            _this7.isFavorite = false;

            _this7.showToast('Resource removed from Favorites.');
          });
          this.firebaseAnalytics.logEvent('favorite_removed', {
            favorite_removed: this.resource.ProgramName
          }); // .then((res: any) => console.log(res))
          // .catch((error: any) => console.error(error));
        }
      }, {
        key: "openWebpage",
        value: function openWebpage() {
          var fixedUrl = this.resource.Website;
          var options = {
            zoom: 'no'
          };
          var browser = this.inAppBrowser.create(fixedUrl, '_system', options);
          this.firebaseAnalytics.logEvent('website_opened', {
            website_visit: this.resource.ProgramName
          }); // .then((res: any) => console.log(res))
          // .catch((error: any) => console.error(error));
        }
      }, {
        ...
        value: function phone() {
          this.callNumber.callNumber(this.resource.TelephoneNumber1, true).then(function () {
            return console.log('Launched dialer!');
          })["catch"](function () {
            return console.log('Error launching dialer');
          });
          this.firebaseAnalytics.logEvent('resource_called', {
            resource_called: this.resource.ProgramName
          }); // .then((res: any) => console.log(res))
          // .catch((error: any) => console.error(error));
        }
      }, {
        ...
        value: function navigate() {
          ...
          this.firebaseAnalytics.logEvent('navigator_opened', {
            resource_navigated: this.resource.ProgramName
          }); // .then((res: any) => console.log(res))
          // .catch((error: any) => console.error(error));
        }
      }, {
        key: "regularShare",
        value: function regularShare() {
          if (this.language == 'en') {
          ...
          this.firebaseAnalytics.logEvent('resource_shared', {
            resource_shared: this.resource.ProgramName
          });
        }
      }, {
        key: "flagResource",
        value: function flagResource() {
          var msg = this.resource.ProgramName + '\n' + this.resource.TelephoneNumber1 + '\n' + this.resource.EmailAddress + '\n' + this.resource.Website + '\n';
          var data = {
            message: msg
          };
          this.openFlagModal(data).then(function () {// this.router.navigate(['/home'])
          });
          this.firebaseAnalytics.logEvent('resource_flagged', {
            resource_flagged: this.resource.ProgramName
          }); // .then((res: any) => console.log(res))
          // .catch((error: any) => console.error(error));
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_2__["CallNumber"], _ionic_native_launch_navigator_ngx__WEBPACK_IMPORTED_MODULE_3__["LaunchNavigator"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_6__["InAppBrowser"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["ToastController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["Platform"], _services_favorites_list_service__WEBPACK_IMPORTED_MODULE_8__["FavoritesListService"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["ActionSheetController"], _ionic_native_firebase_analytics_ngx__WEBPACK_IMPORTED_MODULE_13__["FirebaseAnalytics"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_14__["TranslateService"]])], DetailsPage);

    var snapshotToObject = function snapshotToObject(snapshot) {
      var item = snapshot.val();
      item.key = snapshot.key; // console.log(item);
