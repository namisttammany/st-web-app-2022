...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[40], {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 5:
                  ...
                  _context.next = 8;
                  return regeneratorRuntime.awrap(Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_8__["a"])(this.delegate, container, this.component, ['popover-viewport', this.el['s-sc']], data));

                case 8:
                  this.usersElement = _context.sent;
                  _context.next = 11;
                  return regeneratorRuntime.awrap(Object(_index_4e2fa3c6_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this.usersElement));
          ...
          return regeneratorRuntime.async(function dismiss$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return regeneratorRuntime.awrap(Object(_overlays_e336664a_js__WEBPACK_IMPORTED_MODULE_6__["f"])(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event));
                ...
                case 2:
                  ...
                  _context2.next = 6;
                  return regeneratorRuntime.awrap(Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_8__["d"])(this.delegate, this.usersElement));
  ...
  function node_modulesIonicCoreDistEsmTheme18cbe2ccJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var openURL = function openURL(url, ev, direction) {
      var router;
      return regeneratorRuntime.async(function openURL$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", router.push(url, direction));
